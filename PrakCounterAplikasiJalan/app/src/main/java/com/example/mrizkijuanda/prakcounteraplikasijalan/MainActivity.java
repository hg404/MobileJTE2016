package com.example.mrizkijuanda.prakcounteraplikasijalan;
...
public class MainActivity extends AppCompatActivity {
        ...
        private int ambilCounterHidup() {
            SharedPreferences sharedPreferences = getSharedPreferences("com.example.mrizkijuanda.prakcounteraplikasijalan.MainActivityFragment", Context.MODE_PRIVATE);
